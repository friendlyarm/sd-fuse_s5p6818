...
* pre-built partition image: In the directory "03_Partition image files" of [NetDrive](https://download.friendlyelec.com/s5p6818), or download from [server](https://downloads.friendlyelec.com/os-images/s5p6818/images)
* compressed root file system tar ball: In the directory "06_File systems" of [NetDrive](https://download.friendlyelec.com/s5p6818), or download from [server](https://downloads.friendlyelec.com/rootfs/s5p6818)
...
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/s5p6818/images):
```
git clone https://github.com/friendlyarm/sd-fuse_s5p6818 -b master --single-branch sd-fuse_s5p6818
cd sd-fuse_s5p6818
wget https://downloads.friendlyelec.com/os-images/s5p6818/images/friendlycore-arm64-images.tgz
...
*Note: Here we use friendlycore-arm64 system as an example*  
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/s5p6818/images), here you need to download the friendlycore-arm64 and eflasher [pre-built images](https://downloads.friendlyelec.com/os-images/s5p6818/images):
```
git clone https://github.com/friendlyarm/sd-fuse_s5p6818 -b master --single-branch sd-fuse_s5p6818
cd sd-fuse_s5p6818
wget https://downloads.friendlyelec.com/os-images/s5p6818/images/friendlycore-arm64-images.tgz
tar xvzf friendlycore-arm64-images.tgz
wget https://downloads.friendlyelec.com/os-images/s5p6818/images/emmc-flasher-images.tgz
...
```
wget https://downloads.friendlyelec.com/rootfs/s5p6818/rootfs-friendlycore.tgz
wget https://downloads.friendlyelec.com/rootfs/s5p6818/rootfs-friendlycore.tgz.sha256
