...
if [ $# -eq 0 ]; then
	echo "Usage: $0 DEVICE [friendlycore|friendlycore-arm64|ubuntu-noble-core|ubuntu-noble-core-arm64|friendlycore-arm64|friendlywrt|lubuntu]"
	exit 0
fi
...
if [ ! -f ${TARGET_OS}/bl1-mmcboot.bin -a ! -f ${TARGET_OS}/2ndboot.bin ]; then
	...
	fusing_bin ${BOOT_DIR}/fip-loader.img     129
	fusing_bin ${BOOT_DIR}/fip-secure.img     769
