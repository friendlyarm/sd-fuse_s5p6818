...
wget http://${HTTP_SERVER}/dvdfiles/s5p6818/images-for-eflasher/friendlycore-images.tgz
...
wget http://${HTTP_SERVER}/dvdfiles/s5p6818/images-for-eflasher/friendlycore-lite-focal-images.tgz
...
wget http://${HTTP_SERVER}/dvdfiles/s5p6818/images-for-eflasher/friendlywrt-images.tgz
