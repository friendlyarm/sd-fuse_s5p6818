...
function usage() {
       echo "Usage: $0 <friendlycore-arm64|friendlycore|friendlycore-arm64|friendlycore-lite-noble|friendlycore-lite-noble-arm64|friendlywrt|lubuntu|android|android7>"
       exit 0
}
